  ...
  return (
    <div className="bg-surface-container-lowest rounded-[24px] premium-shadow p-8">
      <div className="text-center mb-8">
        <div className="w-12 h-12 rounded-xl bg-gradient-to-tr from-primary to-secondary flex items-center justify-center text-white mx-auto mb-4">
          <span className="material-symbols-outlined text-[26px]" style={{ fontVariationSettings: "'FILL' 1" }}>cloud</span>
        </div>
        <h2 className="text-page-title font-bold text-on-surface">Create Account</h2>
        <p className="text-on-surface-variant mt-2">Start managing all your cloud storage</p>
      </div>
